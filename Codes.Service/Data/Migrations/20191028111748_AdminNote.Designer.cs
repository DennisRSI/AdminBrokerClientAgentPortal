...
namespace Codes1.Service.Data.Migrations
{
    ...
    [Migration("20191028111748_AdminNote")]
    partial class AdminNote
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Codes1.Service.Models.BookingCommissionBreakdownModel", b =>
                {
                    b.Property<int>("BookingCommissionBreakdownId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<float>("CommissionPrecentage");
                    ...
                    b.HasKey("BookingCommissionBreakdownId");

                    b.HasIndex("BookingId");

                    b.ToTable("BookingCommissionBreakdowns");
                });

            modelBuilder.Entity("Codes1.Service.Models.BookingCommissionModel", b =>
                {
                    b.Property<int>("BookingId");

                    b.Property<string>("AdminNote");

                    b.Property<decimal>("AgentBucketCommission");

                    b.Property<float>("AgentBucketPrecentage");

                    b.Property<string>("BookingType")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.Property<decimal>("BrokerPaidAmount");

                    b.Property<DateTime?>("BrokerPaidDate");

                    b.Property<decimal>("ClientCommission");

                    b.Property<float>("ClientPrecentage");

                    b.Property<decimal>("CompanyBucketCommission");

                    b.Property<float>("CompanyBucketPrecentage");

                    b.Property<decimal>("MemberSavings");

                    b.Property<DateTime?>("RecordChangeDate");

                    b.Property<int?>("RecordChangeRSIId");
            ...
            modelBuilder.Entity("Codes1.Service.Models.ClientAgentModel", b =>
                {
                    ...
                    b.HasKey("ClientAgentId");

                    b.HasIndex("AgentId");

                    b.HasIndex("ClientId");

                    b.ToTable("ClientAgents");
                });
            ...
            modelBuilder.Entity("Codes1.Service.Models.DocumentModel", b =>
                {
            ...
            modelBuilder.Entity("Codes1.Service.Models.PurchaseModel", b =>
                {
                    b.Property<int>("PurchaseId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Codes1.Service.Models.VideoModel", b =>
                {
            ...
            modelBuilder.Entity("Codes1.Service.Models.AgentModel", b =>
                {
                    ...
                    b.HasOne("Codes1.Service.Models.DocumentModel", "DocumentOther")
                        .WithMany()
                        .HasForeignKey("DocumentOtherId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Codes1.Service.Models.DocumentModel", "DocumentW9")
                        .WithMany()
                        .HasForeignKey("DocumentW9Id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Codes1.Service.Models.AgentModel", "ParentAgent")
                        .WithMany()
            ...
            modelBuilder.Entity("Codes1.Service.Models.BookingCommissionBreakdownModel", b =>
                {
                    b.HasOne("Codes1.Service.Models.BookingCommissionModel", "BookingCommission")
                        .WithMany("BookingCommissionBreakdowns")
            ...
            modelBuilder.Entity("Codes1.Service.Models.CampaignModel", b =>
                {
                    ...
                    b.HasOne("Codes1.Service.Models.VideoModel", "PostLoginVideo")
                        .WithMany()
                        .HasForeignKey("PostLoginVideoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Codes1.Service.Models.VideoModel", "PreLoginVideo")
                        .WithMany()
            ...
            modelBuilder.Entity("Codes1.Service.Models.CodeModel", b =>
                {
                    ...
                    b.HasOne("Codes1.Service.Models.PurchaseModel", "Purchase")
                        .WithMany("Codes")
            ...
            modelBuilder.Entity("Codes1.Service.Models.DocumentModel", b =>
                {
                    b.HasOne("Codes1.Service.Models.BrokerModel")
                        .WithMany("Documents")
