    ...
    public class DbInitializer
    {
        ...
        RoleManager<IdentityRole> roleManager, ILogger<DbInitializer> logger)
        {
            List<(string password, string role, ApplicationUser user)> users = new List<(string password, string role, ApplicationUser user)>()
            {
                ...
                ("asdfasdf1", "Administrator", new ApplicationUser()
                    {
                        CompanyName = "Administrator Company",
                        Address = "1 Main St",
                        City = "Seattle",
                        ParentId = "",
                        Country = "USA",
                ...
                ("asdfasdf1", "Broker", new ApplicationUser()
                    {
                ...
                ("asdfasdf1", "Agent", new ApplicationUser()
                    {
                        ...
                        NormalizedUserName = "AGENT@EXAMPLE.COM",
                        PostalCode = "98052",
                        PhoneNumberConfirmed = true,
                        SecurityStamp = Guid.NewGuid().ToString("D"),
                        State = "WA"
                ...
                ("asdfasdf1", "Client", new ApplicationUser()
                    {
